...
import com.gulin.primefacesdatatable.ejb.ActorFacade;
...
public class ActorController implements Serializable {
    ...
    @EJB
    private com.gulin.primefacesdatatable.ejb.ActorFacade ejbFacade;
...
//        FacesMessage msg = new FacesMessage("Actor Edited", ((Actor) event.getObject()).getLastName());  
//  
//        FacesContext.getCurrentInstance().addMessage(null, msg);  
//    }  
//      
//    public void onCancel(RowEditEvent event) {  
//        FacesMessage msg = new FacesMessage("Actor Cancelled", ((Actor) event.getObject()).getLastName());  
//  
//        FacesContext.getCurrentInstance().addMessage(null, msg);  
//    }  
//    
